...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://thawing-anchorage-52719.herokuapp.com/',
...
var blEvents = __webpack_require__(11);
var placeEvents = __webpack_require__(14);
...
var onGetBucketlists = function onGetBucketlists(event) {
  event.preventDefault();
  api.getBucketlists().then(ui.getBukectlistsSuccess).catch(ui.failure);
};

var onCreateBucketlist = function onCreateBucketlist(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.createBucketlist(data).then(function () {
    return onGetBucketlists(event);
  }).catch(ui.failure);
};

var onClearBucketlists = function onClearBucketlists(event) {
  event.preventDefault();
  ui.clearBucketlists();
};
...
var onUpdateBucketlist = function onUpdateBucketlist(event) {
  ...
  api.updateBucketlist(data).then(function () {
    return onGetBucketlists(event);
  }).catch(ui.failure);
};
...
var onDeleteBucketlist = function onDeleteBucketlist(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.deleteBucketlist(data).then(function () {
    return onGetBucketlists(event);
  }).catch(ui.failure);
};
...
var getBucketlists = function getBucketlists() {
  return $.ajax({
    method: 'GET',
    url: config.apiUrl + '/bucketlists/',
    headers: {
...
var updateBucketlist = function updateBucketlist(data) {
  return $.ajax({
...
var deleteBucketlist = function deleteBucketlist(data) {
  return $.ajax({
    url: config.apiUrl + '/bucketlists/' + data.bucketlist.id,
    method: 'DELETE',
    headers: {
...
var getBukectlistsSuccess = function getBukectlistsSuccess(data) {
  $('.displayedBucketlists').empty();
  for (var i = 0; i < data.bucketlists.length; i++) {
    var taskList = data.bucketlists[i].task.split(',');
    ...
    for (var _i = 0; _i < taskList.length; _i++) {
      $('.displayedBucketlists').append('<li>' + taskList[_i] + '</li>');
    }
  }
...
var clearBucketlists = function clearBucketlists() {
  $('.displayedBucketlists').empty();
};
...
module.exports = {
  ...
  getBukectlistsSuccess: getBukectlistsSuccess,
  clearBucketlists: clearBucketlists,
  failure: failure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var onGetPlanets = function onGetPlanets(event) {
  event.preventDefault();
  api.getPlanets().then(ui.getPlanetsSuccess).catch(ui.failure);
};

var onGetPlaces = function onGetPlaces(event) {
  event.preventDefault();
  api.getPlaces().then(ui.getPlacesSuccess).catch(ui.failure);
};
...
var getPlanets = function getPlanets() {
  return $.ajax({
...
var getPlanetsSuccess = function getPlanetsSuccess(data) {
...
module.exports = {
  getPlanetsSuccess: getPlanetsSuccess,
...
module.exports = __webpack_require__.p + "940f8c99c6875d09fa282f8e4c308cfd.jpg";

/***/ }),
/* 28 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "30fbbb0b238c4f2668057fd0aa842e8f.jpg";

/***/ }),
/* 29 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "709f5a4eca8168788ad53b0000740de0.jpg";

/***/ }),
/* 30 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "5ef27abad506e2d839ebfeb4c95612eb.jpg";

/***/ }),
/* 31 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "a6a149133322f3202e797a510d10faaf.jpg";

/***/ }),
/* 32 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "12effd6dd533a7849cad521bcc6beeab.jpg";
